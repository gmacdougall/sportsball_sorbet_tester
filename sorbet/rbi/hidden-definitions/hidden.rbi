...
class ActionDispatch::SystemTesting::Server
  ...
  def self.silence_puma=(silence_puma); end
end
...
class Game
  ...
  def autosave_associated_records_for_first_team(*args); end

  def autosave_associated_records_for_second_team(*args); end
end
...
class Packwerk::Inflections::Custom
  ...
  def inflections=(inflections); end
...
class Packwerk::PackageSet
  def self.load_all_from(root_path, package_pathspec: T.unsafe(nil)); end
...
module PredictionsController::HelperMethods
